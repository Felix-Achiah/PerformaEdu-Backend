...
from .models import Class, TeacherLevelClass, Subject, Assessment, ClassEnrollment, Student, HistoricalClassEnrollment, SubjectPerformance, ProcessedMarks, StudentParentRelation, TimeTable
...
class ClassEnrollmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'student', 'class_id', 'class_name', 'academic_year', 'status']
...
class StudentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Student
        fields = ['id', 'name', 'date_of_birth', 'age', 'gender', 'created_at', 'updated_at', 'class_enrollment', 'historical_class_enrollment']
...
class TeacherLevelClassSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'teacher', 'class_id', 'class_name', 'subjects_taught', 'subjects_taught_details', 'is_main_teacher']
